...
*/
const animalNames = [];
let output = zooAnimals.forEach(element => animalNames.push('Name: ' + element.animal_name + ', Scientific: ' +element.scientific_name))
...
*/
const populationTotal = zooAnimals.filter((element) => {
